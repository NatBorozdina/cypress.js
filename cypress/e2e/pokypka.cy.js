describe('Автотесты на покупку аватара тренера', function () {
    it('Покупка аватара', function () {
         ...
         cy.get(':nth-child(1) > .auth__input').type('natalya-shashko@yandex.ru');
         cy.get('#password').type('Bylbrfwbz1');
         ...
         cy.get('.pay__input-box-last-of > .pay_base-input-v2').type('NATALYA BOROZDINA');
